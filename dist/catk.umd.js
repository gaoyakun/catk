...
var Graph = /** @class */ (function () {
    ...
    Graph.prototype.histogram = function (options) {
        ...
        if (maxValue > 0) {
            ...
            for (var i = 0; i < options.values.length; i++) {
                var top_1 = barTop + Math.round((barHeight * (maxValue - options.values[i])) / maxValue);
                var height = this.canvasHeight - paddingV - top_1;
                this.ctx.fillRect(barLeft, top_1, barWidth, height);
                barLeft += barWidth;
                barLeft += paddingH;
            }
        }
...
//# sourceMappingURL=catk.umd.js.map
